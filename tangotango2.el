...
(custom-theme-set-faces
 ...
 ;; - green :      "#6ac214"
 ;; - orange/red : "tomato"
 `(default ((t (:weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "#eeeeec" :background "#161820" :stipple nil :inherit nil))))
 ...
 `(font-lock-function-name-face ((t (:weight normal :foreground "#edd400"))))
