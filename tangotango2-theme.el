...
(custom-theme-set-faces
 ...
 `(escape-glyph ((((background dark)) (:foreground "cyan")) (((type pc)) (:foreground "#eeeeec")) (t (:foreground "brown"))))
 `(highlight ((t (:background "green"))))
 `(region ((t (:background "#789c78"))))
 ...
 `(font-lock-constant-face ((t (:foreground "#30cc30"))))
 `(font-lock-doc-face ((t (:foreground "#888a85"))))
 `(font-lock-function-name-face ((t (:weight normal :foreground "#eeeeec"))))
 `(font-lock-keyword-face ((t (:weight normal :foreground "#729fcfz"))))
 ...
 `(font-lock-string-face ((t (:slant italic :foreground "#969cd6"))))
 ...
 `(link-visited ((default (:inherit (link))) (((class color) (background light)) (:foreground "dark blue")) (((class color) (background dark)) (:foreground "dark blue"))))
 ...
 `(org-date ((t (:underline t :foreground "#eeeeec"))))
 `(org-footnote  ((t (:underline t :foreground "#eeeeec"))))
 `(org-link ((t (:foreground "skyblue2" :background "#2e3436" :underline nil))))
 `(org-special-keyword ((t (:foreground "brown"))))
 `(org-verbatim ((t (:foreground "#eeeeec" :underline t :slant italic))))
 `(org-block ((t (:foreground "#bbbbbc" :background "#2a3a4a"))))
 ...
 `(org-block-begin-line ((t ( :foreground "#888a85" :background "#2a3a4a"))))
 `(org-block-background ((t (:background "#252b2b"))))
 `(org-block-end-line ((t ( :foreground "#888a85" :background "#2a3a4a"))))
