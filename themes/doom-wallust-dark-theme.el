...
(def-doom-theme doom-wallust-dark
                ...
                ((bg         '("#141517" nil       nil))
                 ...
                 (bg-alt     '("#3E3F42" nil       nil))
                 (fg-alt     '("#997972" nil       nil))

                 ;; Base colors - spectrum from bg to fg
                 (base0      '("#3E3F42" nil "black"))
                 ...
                 (base8      '("#DAAEA2" nil "white"))

                 (grey       base5)
                 (red        '("#45484E" nil "red"))
                 (orange     '("#484D55" nil "brightred"))
                 (green      '("#6A575B" nil "green"))
                 (teal       '("#A97264" nil "brightgreen"))
                 (yellow     '("#56616E" nil "yellow"))
                 (blue       '("#6B757F" nil "brightblue"))
                 (dark-blue  '("#758390" nil "blue"))
                 (magenta    '("#778289" nil "magenta"))
                 (violet     '("#768692" nil "brightmagenta"))
                 (cyan       '("#C76D57" nil "brightcyan"))
